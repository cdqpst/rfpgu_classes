 ...
 */
public class ChoiceGroupDialog extends DialogFragment implements AdapterView.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(groupList != null) {
            listView.setAdapter(new ArrayAdapter<Integer>(getActivity(), R.layout.dialog_lv_item, groupList));
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        pref.edit().putString(Settings.DEF_GROUP, String.valueOf(groupList.get(position))).commit();
        getDialog().dismiss();
        reloadFragment();
    }
